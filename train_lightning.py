...
# Remove exact duplicate image Data/I/002.jpg
...
print("Fast-loading images into RAM via 16 threads...")
t0 = time.time()
...
print(f"Data pre-cached in RAM in {time.time() - t0:.2f} seconds!")
...
# CNN Architecture matching prompt specifications exactly
